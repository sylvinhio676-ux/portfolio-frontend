...
// Icône GitHub personnalisée (SVG officiel)
...
// Icône LinkedIn personnalisée (SVG officiel)
    ...
    <footer className="border-t border-border bg-surface">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://github.com/sylviniho676-u"
                target="_blank"
              ...
              <a
                href="mailto:sylviniho676@gmail.com"
                className="p-2 bg-card border border-border rounded-lg hover:border-primary transition-colors"
                aria-label="Email"
              >
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>&copy; {currentYear} Negoue Tamo Sylviniho. Tous droits réservés.</p>
